							...
							<div class="panel panel-default">
								<div class="panel-body">
									...
									<?php foreach ($record as $row) { ?>
										<form action="<?php echo base_url();?>ams/edit_stocks?item_number=<?php echo $row->item_number; ?>" method="post">
											<table class="table table-striped table-hover">
												<tbody>
													...
													<tr>
														<td colspan="2">
															<input type="submit" name="btnSubmit" class="btn btn-success btn-block" value="Submit">
														</td>
													</tr>
												</tbody>
											</table>
												...
												<div class="form-horizontal">
													...
													<div class="form-group">
														...
														<div class="col-sm-9 controls">
															<div class="row">
																<div class="col-xs-9">
																	<input type="text" class="form-control" value="<?php echo $row->category; ?>" name="txtCategory" />
																</div>
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-9 controls">
															<div class="row">
																<div class="col-xs-9">
																	<input type="text" class="form-control" value="<?php echo $row->vendor; ?>" name="txtVendor" />
																</div>
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-9 controls">
															<div class="row">
																<div class="col-xs-9">
																	<input type="text" class="form-control" value="<?php echo $row->location; ?>" name="txtLocation" />
																</div>
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-9 controls">
															<div class="row">
																<div class="col-xs-9">
																	<input type="text" type="text" class="form-control" value="<?php echo $row->quantity; ?>" name="txtQuantity" />
																</div>
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-9 controls">
															<div class="row">
																<div class="col-xs-9">
																	<input type="text" type="text" class="form-control" value="<?php echo $row->price; ?>" name="txtPrice" />
																</div>
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-9 controls">
															<div class="row">
																<div class="col-xs-9">
																	<input type="text" type="text" class="form-control" value="<?php echo date('M d, Y',strtotime($row->date_added)); ?>" name="" disabled/>
																</div>
															</div>
														</div>
													</div>
